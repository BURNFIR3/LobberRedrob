...
**Live Demo:** [huggingface.co/spaces/Burnfir3/LobberRedrob](https://huggingface.co/spaces/Burnfir3/LobberRedrob)  
**GitHub:** [github.com/BURNFIR3/LobberRedrob](https://github.com/BURNFIR3/LobberRedrob)
...
The pipeline can be run interactively at:

**[https://huggingface.co/spaces/Burnfir3/LobberRedrob](https://huggingface.co/spaces/Burnfir3/LobberRedrob)**

The interface accepts either the pre-loaded 100-candidate extract or a custom `.jsonl` upload, executes both pipeline stages, and produces a downloadable `submission.csv`. It runs on the Hugging Face free CPU tier and completes within the 5-minute compute budget specified in the submission rules.
